...
.catch (err  => {
  ...
  return (
    ...
    >
     ...
     <>
     <br/>
<h3 style={{ color:"#43919B"}}>  gestion Réclamation</h3>
        ...
        <table  className="table table-bordered" >  
         <thead > 
                ...
                <th scope="col"> Utilisateur</th> 
                           ...
                           <th scope="col" style={{textAlign:"center"}}> lien</th>
              ...
              (reclamations) => {
                ...
                if (motCle == "") {
                  return (
                      ...
                      <td>{reclamations.user.login}</td>
                      
                      <td>{reclamations.user.numTel}</td>
                      <td>{reclamations.raison}</td>
                      
                      <td>{reclamations. dateCreation}</td>
                      ...
                      <center>
                        ...
                        <Button  style={{backgroundColor:"#56BBF1"}} variant="contained" onClick={
                          ()=>{
                            setIdReclamation(reclamations._id);
                            setOpen(true);
                      ...
                      <td><Button style={{backgroundColor:"#56BBF1"}}  variant="contained"onClick={()=>{window.location="/annonceRéclamation"}}>reclamations.annonce.titre</Button>
                        </td>
                ...
                }else if(reclamations.titre.toUpperCase().includes(motCle.toUpperCase())){
                  return (
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description" >
           Vous-êtes sûr de supprimer cette réclamation.. ?
          </DialogContentText>
        </DialogContent>
        <DialogActions>
...
axios.delete(`http://localhost:7000/api/reclamation/delete/${idReclamation}`)
.then(
    res => console.log(res),
    setOpen(false),
    window.location="/gestionRéclamation"
